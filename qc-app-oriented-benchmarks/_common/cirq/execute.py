...
def transpile_for_metrics(qc):
    ...
    cirq.testing.assert_circuits_with_terminal_measurements_are_equivalent(qc, optimized_circuit)     #To ensure optimized circuit is equivalent to original circuit in terms of final measurements
