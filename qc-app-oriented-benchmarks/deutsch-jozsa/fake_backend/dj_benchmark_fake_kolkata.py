...
def balanced_oracle (input_size, num_qubits):
    ...
    b_str = "10101010101010101010101010101010"              # permit input_string up to 32 chars
...
def run (min_qubits=2, max_qubits=8, skip_qubits=1, max_circuits=3, num_shots=1000,
        backend_id='fake_kolkata', provider_backend=None,
