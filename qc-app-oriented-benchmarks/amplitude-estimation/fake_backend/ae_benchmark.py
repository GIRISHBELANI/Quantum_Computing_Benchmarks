...
def run(min_qubits=3, max_qubits=16, skip_qubits=1, max_circuits=3, num_shots=1000,
    ...
    metrics.plot_metrics(f"Benchmark Results - {benchmark_name} - Qiskit", options = exec_options)  # --exec_options '{"plot_memory_usage": "True"}' [pass from terminal to get the memory usage plot]
