...
metrics.data_suffix = "_noisefree_GPU"
...
# metrics.data_suffix = "HHL_2_noisefree"
...
backend_id = 'statevector_simulator_noisefree_GPU'       

# Call the json_to_excel function
metrics.json_to_excel(benchmark_folder, api, backend_id)

# backend_id = 'statevector_simulator_HHL_2_noisefree_GPU'       
# metrics.json_to_excel(benchmark_folder, api, backend_id)
