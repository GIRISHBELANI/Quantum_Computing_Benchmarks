"""
Hydogen Lattice Benchmark Program - Qiskit (fake_guadalupe)
"""
...
def submit_to_estimator(qc=None, num_qubits=1, unique_id=-1, parameterized=False, params=None, operator=None, num_shots=1000, backend_id=None, provider_backend=None):
    ...
    if backend_id.lower() == "statevector_simulator":
        ...
        estimator = Estimator()  # for fake backends
    else:
