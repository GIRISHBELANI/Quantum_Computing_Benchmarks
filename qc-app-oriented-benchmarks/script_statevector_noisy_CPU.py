...
# metrics.data_suffix = "_HHL_2_noisy"
...
benchmark_folder = ''   
api = ''               #qiskit, cirq, braket, fake_backend, qiskit-statevector
backend_id = 'statevector_simulator_noisy'       

# Call the json_to_excel function
metrics.json_to_excel(benchmark_folder, api, backend_id)


# backend_id = 'statevector_simulator_HHL_2_noisy'       
# metrics.json_to_excel(benchmark_folder, api, backend_id)
